...
<p><code>import boto3 # type: ignore</code></p>
<p>### minimum instance type----this code sets the minimum instance type that will be created<code>
mini_instancetype = "t2.medium"</code></p>
<p>### list of all instance_types------------this code list all the instance type, it can be gotten from ec2 boto3 documentation<code>
instance_order = [
    "t2.nano", "t3.nano",
    "t2.micro", "t3.micro",
    "t2.small", "t3.small",
...
<p>## this code stores the instance id<code>Ec2 InstanceIds = [] # type: ignore</code></p>
<p>The response variable is found in the describe instance boto3 documentation. the code below should be run in a separate file in vscode, always remember this<code>
...
def get_all_instances():# type: ignore
    ...
    for i in response["Reservations"]:
     for j in i["instances"]:
        ...
        instance_type = j[instance_type]</code></p>
  <p>##check if the instance type is greater than minimum<code> 
    ...
    return Ec2 InstanceIds # type: ignore</code></p>
<p>### terminate instance<code>
def terminate_instance(instance_ids):
    client = boto3.client('ec2')
    response = client.terminate_instances(InstanceIds = instance_ids)
    return response</code></p>
<p>##lambda header<code>
def lambda_handler(event, context):
    client = boto3.client('ec2')
    instance_to_terminate = get_all_instances()
    terminate_instance(instance_to_terminate)</code></p>
